...
with open('day02_input.txt', 'r') as f:
    for round in f:
        ...
        scores.append(score_card[them][me])

print(f'My total score according to the strategy guide is {sum(scores):,}.')
...
print(f'My total score acc. to the new strategy guide is {sum(scores):,}.')